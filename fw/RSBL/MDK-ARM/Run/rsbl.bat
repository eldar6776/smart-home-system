ECHO OFF
C:\Keil\ARM\Utilities\srecord\srec_cat Exe\rsbl.hex -intel -offset -0x8000000 -crop 0 0xFFF0 -Exclusive_Length_Little_Endian 0xFFF0 -fill 0xFF 0 0xFFF0 -o Exe\tmp1.hex -intel
...
C:\Keil\ARM\Utilities\srecord\srec_cat Exe\tmp6.hex -intel -o Out\IMG23.RAW -binary
C:\Keil\ARM\Utilities\srecord\srec_cat Exe\tmp6.hex -intel -offset 0x08000000 -o Out\RSBL.HEX -intel
exit