...
#define LightOn()                   (HAL_GPIO_WritePin(GPIOD, GPIO_PIN_2, GPIO_PIN_SET))
#define LightOff()                  (HAL_GPIO_WritePin(GPIOD, GPIO_PIN_2, GPIO_PIN_RESET))
#define IsLightActiv()              (HAL_GPIO_ReadPin (GPIOD, GPIO_PIN_2) == GPIO_PIN_SET)
