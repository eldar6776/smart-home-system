...
#define LadderUpOn()                (HAL_GPIO_WritePin(GPIOC, GPIO_PIN_10, GPIO_PIN_SET))
#define LadderUpOff()               (HAL_GPIO_WritePin(GPIOC, GPIO_PIN_10, GPIO_PIN_RESET))
#define IsLadderUpActive()          (HAL_GPIO_ReadPin (GPIOC, GPIO_PIN_10) == GPIO_PIN_SET)
#define LadderDownOn()              (HAL_GPIO_WritePin(GPIOC, GPIO_PIN_11, GPIO_PIN_SET))
#define LadderDownOff()             (HAL_GPIO_WritePin(GPIOC, GPIO_PIN_11, GPIO_PIN_RESET))
#define IsLadderDownActive()        (HAL_GPIO_ReadPin (GPIOC, GPIO_PIN_11) == GPIO_PIN_SET)
