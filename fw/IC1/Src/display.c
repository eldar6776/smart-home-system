...
uint8_t btn_ok_state, btnset, old_min=60;;
...
static uint8_t menu_thst, screen, ctrl1, ctrl2, ctrl3;
...
static void SaveThermostatController(THERMOSTAT_TypeDef* tc, uint16_t addr);
/* Program Code  -------------------------------------------------------------*/
/**
  * @brief
  * @param
...
void PID_Hook(GUI_PID_STATE * pTS){
    ...
    if (pTS->Pressed  == 1U){
        ...
        if ((pTS->x > 400) && (pTS->y < 60) && ((screen < 2) || (screen == 6))){
            click = 1;
            if      (screen  < 2) screen = 2;
            else if (screen == 6) screen = 7;
        }else if((pTS->x > 0)&&(pTS->x < 240)&&(pTS->y > 0)&&(pTS->y < 272)&&(screen == 2)){
            click = 1;
            screen = 3;
            ...
            click = 1;
            screen = 7;
        }else if((pTS->x > 240)&&(pTS->y > 100)&&(pTS->x < 480)&&(pTS->y < 272)&&(screen == 2)){
            click = 1;
            screen = 6;
        }else if((pTS->x > BTN_INC_X0)&&(pTS->y > BTN_INC_Y0)&&(pTS->x < BTN_INC_X1)&&(pTS->y < BTN_INC_Y1)&&(screen == 6)){
            click = 1;
            btninc = 1;
        }else if((pTS->x > BTN_DEC_X0)&&(pTS->y > BTN_DEC_Y0)&&(pTS->x < BTN_DEC_X1)&&(pTS->y < BTN_DEC_Y1)&&(screen == 6)){
            click = 1;
            btndec = 1;
