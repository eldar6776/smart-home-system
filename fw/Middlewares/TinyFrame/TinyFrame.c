 ...
 ******************************************************************************
 *
 * dodati opciju retransmisije paketa prije greske ili prekida
 * 
 ******************************************************************************
 */
...
#elif TF_CKSUM_TYPE == TF_CKSUM_CRC8	// nepotrebno - imamo hardwerski modul na STM32-u
...
#elif TF_CKSUM_TYPE == TF_CKSUM_CRC16	// nepotrebno - imamo hardwerski modul na STM32-u
...
#elif TF_CKSUM_TYPE == TF_CKSUM_CRC32	// nepotrebno - imamo hardwerski modul na STM32-u
...
//region Listeners
//
//	korisno za master kontroler busa, kojeg cemo izbjegavat u sirokom luku
//	u kontroli za kucu, jer predstavlja bolnu tacku čijim otkazom
//  prestaju i sve ostale ispravne funkcije sistema
//
...
//
// postoji greška u ovoj funkciji, jer se pointeri na ->userdata bufere mogu promjeniti unutar 
// pozvane funcije, što bi trabalo obradit prije jednostavnog brisanja registrovane instance
// koja može uništit fajl ili registar adresiran pointerom....
//
...
//
//	za svaki poslani telegram otvarati po jedan ID listener dok god ima slobodne RAM memorije
// 	obavezno dodati u funkciju koja uklanja registrovane ID listenere nakon timouta telegrama 
//  da prije brisanja pozove ErrorHandler funkciju u kojoj se ponavlja, obustavlja ili sta god.....
//
...
//
//	iako mu to vjeravoatno nije osnovna namjena, odličan je za definisanje grupa
//  bez obzira na uređaj, u funkcija se moze prosiriti da se dinamicki registruju
//  pozivi za telegrame sa određenog tipa, tako da svi uređaji u kući mogu dobiti
//  ulogu da na bilo koju promjenu upale alarm... i sl
//
...
//
//	obavezno registtrovati jednu instancu generic listenera za svaku inicijalizovanu
//  tinyframe instancu/strukturu. veoma korisno je obzirom da "kupi sve gelere"
// 	svaki ispravno primljen telegram na busu kod svakog uređaja ce proci kroz ovu funkciju
// 	ako je registrovana, tako da se kroz nju moze pratiti broadcast, address resolution request
//	i sve interne poruke sistema.  
//
...
//
// 	nakon svake potvrde prijema telegrama treba obrisati listener 
//	registrovan za pracenje tog telegrama ili slijedi raspad kontrole RAM-a
//
 ...
 */
static __inline uint32_t _TF_FN TF_ComposeBody(uint8_t *outbuff,const uint8_t *data, TF_LEN data_len,TF_CKSUM *cksum){
    TF_LEN i = 0;
    uint8_t b = 0;
    uint32_t pos = 0;
...
//
//	obavezno u stm32 SysTick_Handler dodati poziv za ovu funkciju
// 	zbog neovisnog i preciznog timiga cijelog TinyFrame-a
//	ne pozivati nijednu funkciju direktno odAvde obzirom 
//  da je i sama pozvana iz IRQ-a najvišeg prioriteta.
//  vjerovatnoca poziva HAL drivera sa HardFault-om je 101%
//
