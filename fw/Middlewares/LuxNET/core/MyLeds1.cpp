...
inline void ledsInit()
{
	...
	hwPinMode(MY_HW_RX_LED_PORT, MY_HW_RX_LED_PIN,  OUTPUT);
#endif
#if (defined(MY_HW_TX_LED_PORT) && defined(MY_HW_TX_LED_PIN))
	hwPinMode(MY_HW_TX_LED_PORT, MY_HW_TX_LED_PIN,  OUTPUT);
#endif
#if (defined(MY_HW_ERR_LED_PORT) && defined(MY_ERR_TX_LED_PIN))
	hwPinMode(MY_HW_ERR_LED_PORT, MY_HW_ERR_LED_PIN,  OUTPUT);
#endif
	prevTime = hwMillis() -
...
|| 	(defined(MY_HW_ERR_LED_PORT) && defined(MY_HW_ERR_LED_PIN)))
	...
	hwDigitalWrite(MY_HW_RX_LED_PORT, MY_HW_RX_LED_PIN, state);
#endif
	...
	hwDigitalWrite(MY_HW_TX_LED_PORT, MY_HW_TX_LED_PIN, state);
#endif
	...
	hwDigitalWrite(MY_HW_ERR_LED_PORT, MY_HW_ERR_LED_PIN, state);
#endif
}
