...
inline void ledsInit()
{
	...
	// Setup led pins
#if (defined(MY_HW_RX_LED_PORT) && defined(MY_HW_RX_LED_PIN))
	GPIO_SetPinMode(MY_HW_RX_LED_PORT, MY_HW_RX_LED_PIN, GPIO_MODE_OUTPUT_PP);
#endif
#if (defined(MY_HW_TX_LED_PORT) && defined(MY_HW_TX_LED_PIN))
	GPIO_SetPinMode(MY_HW_TX_LED_PORT, MY_HW_TX_LED_PIN, GPIO_MODE_OUTPUT_PP);
#endif
#if (defined(MY_HW_ERR_LED_PORT) && defined(MY_HW_ERR_LED_PIN))
	GPIO_SetPinMode(MY_HW_ERR_LED_PORT, MY_HW_ERR_LED_PIN, GPIO_MODE_OUTPUT_PP);
#endif
	prevTime = hwMillis() -
...
void ledsProcess()
{
	...
	HAL_GPIO_WritePin(MY_HW_RX_LED_PORT, MY_HW_RX_LED_PIN, state ? GPIO_PIN_SET : GPIO_PIN_RESET);
#endif
	...
	HAL_GPIO_WritePin(MY_HW_TX_LED_PORT, MY_HW_TX_LED_PIN, state ? GPIO_PIN_SET : GPIO_PIN_RESET);
#endif
	...
	HAL_GPIO_WritePin(MY_HW_ERR_LED_PORT, MY_HW_ERR_LED_PIN, state ? GPIO_PIN_SET : GPIO_PIN_RESET);
#endif
}
