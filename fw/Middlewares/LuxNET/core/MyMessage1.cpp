...
_Bool MyMessage::isProtocolVersionValid(void) const
{
...
_Bool MyMessage::isAck(void) const
{
	return this->isEcho();
}

_Bool MyMessage::isEcho(void) const
{
	return (_Bool)BF_GET(this->command_echo_payload, V2_MYS_HEADER_CEP_ECHO_POS,
	                    V2_MYS_HEADER_CEP_ECHO_SIZE);
}

MyMessage& MyMessage::setEcho(const _Bool echo)
{
...
_Bool MyMessage::getRequestEcho(void) const
{
	return (_Bool)BF_GET(this->command_echo_payload, V2_MYS_HEADER_CEP_ECHOREQUEST_POS,
	                    V2_MYS_HEADER_CEP_ECHOREQUEST_SIZE);
}

MyMessage& MyMessage::setRequestEcho(const _Bool requestEcho)
{
...
_Bool MyMessage::getSigned(void) const
{
	return (_Bool)BF_GET(this->version_length, V2_MYS_HEADER_VSL_SIGNED_POS,
	                    V2_MYS_HEADER_VSL_SIGNED_SIZE);
}

MyMessage& MyMessage::setSigned(const _Bool signedFlag)
{
...
_Bool MyMessage::get_Bool(void) const
{
	return (_Bool)this->getByte();
}
