...
inline void inclusionInit()
{
	...
	hwPinMode(MY_INCLUSION_MODE_BUTTON_PORT, MY_INCLUSION_MODE_BUTTON_PIN, INPUT_PULLUP);
#endif
#if (defined (MY_INCLUSION_LED_PORT) && defined (MY_INCLUSION_LED_PIN))
	// Setup LED pin that indicates inclusion mode
	hwPinMode(MY_INCLUSION_LED_PORT, MY_INCLUSION_LED_PIN, OUTPUT);
	hwDigitalWrite(MY_INCLUSION_LED_PORT, MY_INCLUSION_LED_PIN, LED_OFF);
#endif

}


void inclusionModeSet(_Bool newMode)
{
...
#if (defined (MY_INCLUSION_LED_PORT) && defined (MY_INCLUSION_LED_PIN))
	hwDigitalWrite(MY_INCLUSION_LED_PORT, MY_INCLUSION_LED_PIN, _inclusionMode ? LED_ON : LED_OFF);
#endif
}
...
inline void inclusionProcess()
{
	...
	if (!_inclusionMode && (hwDigitalRead(MY_INCLUSION_MODE_BUTTON_PORT, MY_INCLUSION_MODE_BUTTON_PIN) == MY_INCLUSION_BUTTON_PRESSED)) {
