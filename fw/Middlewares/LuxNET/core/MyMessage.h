...
typedef enum {
	...
	S_LUX_NODE			    = 17,	//!< Used (internally) for presenting a non-repeating Arduino node
	S_LUX_REPEATER_NODE	    = 18,	//!< Used (internally) for presenting a repeating Arduino node
