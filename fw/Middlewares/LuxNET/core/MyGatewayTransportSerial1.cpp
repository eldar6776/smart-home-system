...
uint8_t _serialInputPos = 0;
MyMessage _serialMsg;

// cppcheck-suppress constParameter
_Bool gatewayTransportSend(MyMessage &message)
{
	char* msg = protocolMyMessage2Serial(message);
	int len = strlen(msg);
...
_Bool gatewayTransportInit(void)
{
