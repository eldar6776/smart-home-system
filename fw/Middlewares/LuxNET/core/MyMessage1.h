...
public:
	...
	/**
	 * @brief Get _Bool payload
	 * @return a _Bool with the value of the payload (true/false)
	 */
	_Bool get_Bool(void) const;
	...
	*/
	_Bool isProtocolVersionValid(void) const;

	/**
	 * @brief Getter for echo request
	 * @return echo request
	 */
	_Bool getRequestEcho(void) const;

	/**
	 * @brief Setter for echo request
	 * @param requestEcho
	 */
	MyMessage& setRequestEcho(const _Bool requestEcho);
	...
	* @return sign field
	*/
	_Bool getSigned(void) const;

	/**
	 * @brief Setter for sign field
	 * @param signedFlag
	 */
	MyMessage& setSigned(const _Bool signedFlag);
	 ...
	 */
	_Bool isAck(void) const;

	/**
	 * @brief Getter for echo-flag.
	 * @return true if this is an echoed message
	 */
	_Bool isEcho(void) const;

	/**
	* @brief Setter for echo-flag.
	* @param echo true if this an echo message
	*/
	MyMessage& setEcho(const _Bool echo);
	...
	*/
	...
	/**
	 * @brief Set payload to _Bool value
...
#pragma anon_unions
         __packed struct { //!< Float messages
