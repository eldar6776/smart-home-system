/**
 ******************************************************************************
 * Project		: Kuce Dzevadova
 * Date 		: 28/04/2020 23:16:19
...
#define LUXNET_PROTOCOL_VERSION      		(2u) 	//!< Protocol version
#define LUXNET_HEADER_SIZE                  	(7u) 	//!< Header size
#define LUXNET_HEADER_MAX_MESSAGE_SIZE      	(32u) 	//!< Max payload size

#define LUXNET_HEADER_VSL_VERSION_POS       	(0) 	//!< bitfield position version
#define LUXNET_HEADER_VSL_VERSION_SIZE      	(2u) 	//!< size version field
#define LUXNET_HEADER_VSL_SIGNED_POS        	(2u) 	//!< bitfield position signed field
#define LUXNET_HEADER_VSL_SIGNED_SIZE       	(1u) 	//!< size signed field
#define LUXNET_HEADER_VSL_LENGTH_POS        	(3u) 	//!< bitfield position length field
#define LUXNET_HEADER_VSL_LENGTH_SIZE       	(5u) 	//!< size length field

#define LUXNET_HEADER_CEP_COMMAND_POS       	(0) 	//!< bitfield position command field
#define LUXNET_HEADER_CEP_COMMAND_SIZE      	(3u) 	//!< size command field
#define LUXNET_HEADER_CEP_ECHOREQUEST_POS   	(3u) 	//!< bitfield position echo request field
#define LUXNET_HEADER_CEP_ECHOREQUEST_SIZE	    (1u)	//!< size echo request field
#define LUXNET_HEADER_CEP_ECHO_POS          	(4u) 	//!< bitfield position echo field
#define LUXNET_HEADER_CEP_ECHO_SIZE         	(1u) 	//!< size echo field
#define LUXNET_HEADER_CEP_PAYLOADTYPE_POS   	(5u) 	//!< bitfield position payload type field
#define LUXNET_HEADER_CEP_PAYLOADTYPE_SIZE  	(3u) 	//!< size payload type field

#define MAX_MESSAGE_SIZE	LUXNET_HEADER_MAX_MESSAGE_SIZE		//!< The maximum size of a message (including header)
#define HEADER_SIZE		LUXNET_HEADER_SIZE					//!< The size of the header
...
typedef enum {
	...
	C_INTERNAL     = 3,	//!< Internal luxnet messages (also include common messages provided/generated by the library).
