...
DWORD get_fattime ()
{
    ...
    return (((rtc_date.RTC_Year + 2000)-1980)<<25)   // Year
            |(rtc_date.RTC_Month << 21)              // Month
            |(rtc_date.RTC_Date << 16)               // Date
            |(rtc_time.RTC_Hours << 11)              // Hour 
            |(rtc_time.RTC_Minutes << 5)             // Min
            |(rtc_time.RTC_Seconds >> 1);            // Sec
}
