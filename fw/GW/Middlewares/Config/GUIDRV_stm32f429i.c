...
*/
  ...
  #define DISP_DRIVER_0   GUIDRV_LIN_32
#elif (COLOR_MODE_0 == _CM_RGB888)
  #define COLOR_CONVERSION_0 GUICC_M888
  #define DISP_DRIVER_0   GUIDRV_LIN_24
#elif (COLOR_MODE_0 == _CM_RGB565)
  #define COLOR_CONVERSION_0 GUICC_M565
  #define DISP_DRIVER_0   GUIDRV_LIN_16 //
  ...
  #define DISP_DRIVER_0   GUIDRV_LIN_8
...
void LCD_X_Config(void)
{
	...
	//
	GUI_DEVICE_CreateAndLink(DISP_DRIVER_0, COLOR_CONVERSION_0, 0, 0);
	//
    ...
    //
    GUI_DEVICE_CreateAndLink(DISP_DRIVER_1, COLOR_CONVERSION_1, 0, 1);
    //
