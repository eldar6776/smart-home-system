...
#define LightOn()                   (HAL_GPIO_WritePin(GPIOC, GPIO_PIN_12, GPIO_PIN_SET))
#define LightOff()                  (HAL_GPIO_WritePin(GPIOC, GPIO_PIN_12, GPIO_PIN_RESET))
#define IsLightActive()             (HAL_GPIO_ReadPin (GPIOC, GPIO_PIN_12) == GPIO_PIN_SET)
#define BlindUpOn()                 (HAL_GPIO_WritePin(GPIOC, GPIO_PIN_10, GPIO_PIN_SET))
#define BlindUpOff()                (HAL_GPIO_WritePin(GPIOC, GPIO_PIN_10, GPIO_PIN_RESET))
#define IsBlindUpActive()           (HAL_GPIO_ReadPin (GPIOC, GPIO_PIN_10) == GPIO_PIN_SET)
#define BlindDownOn()               (HAL_GPIO_WritePin(GPIOC, GPIO_PIN_11, GPIO_PIN_SET))
#define BlindDownOff()              (HAL_GPIO_WritePin(GPIOC, GPIO_PIN_11, GPIO_PIN_RESET))
#define IsBlindDownActive()         (HAL_GPIO_ReadPin (GPIOC, GPIO_PIN_11) == GPIO_PIN_SET)
