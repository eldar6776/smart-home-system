@ECHO OFF
C:\Keil\ARM\Utilities\srecord\srec_cat Exe\rs.hex -intel -offset -0x08010000 -crop 0 0xEFFF0 -Exclusive_Length_Little_Endian 0xEFFF0 -fill 0xFF 0 0xEFFF0 -o Exe\tmp1.hex -intel
...
C:\Keil\ARM\Utilities\srecord\srec_cat Exe\tmp6.hex -intel -o Out\IMG22.RAW -binary
C:\Keil\ARM\Utilities\srecord\srec_cat Exe\tmp6.hex -intel  -offset 0x08010000 -o Out\RS.HEX -intel
C:\Keil\ARM\Utilities\srecord\srec_cat Out\ER_QSPI1 -binary -offset 0x90000000 -o Out\EXT.HEX -intel
C:\Keil\ARM\Utilities\srecord\srec_cat ..\..\RSBL\MDK-ARM\Out\RSBL.HEX -intel Out\RS.HEX -intel Out\EXT.HEX -intel -o Out\RS_ALL_IN_ONE.HEX -intel
exit