...
/* USB system version */
#define USB_VERSION  30004UL // Format: Mmmrr. Example: 30004 is 3.00d
...
#define USB_READ_MODE_SINGLE_PACKET (1 << 1)     // Request no more than a single packet at once from the driver.
...
void USBD_SetWarnFunc                   (void (*pfWarn)(const char *));
...
extern const USB_HW_DRIVER USB_Driver_Freescale_K40;
extern const USB_HW_DRIVER USB_Driver_Freescale_K60;
extern const USB_HW_DRIVER USB_Driver_Freescale_K70;
...
extern const USB_HW_DRIVER USB_Driver_ST_STM32F0;
