...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { CHECKBOX_CreateIndirect,  0,                   GUI_ID_CHECK1    , 235, 205,  70,   0, 0,                    0, 0 },
};
...
static void _ToggleFullScreenMode(WM_HWIN hDlg) {
  ...
  if (FullScreenMode) {
    ...
    WM_MoveWindow(hButton, 0, -11);
    WM_ForEachDesc(hClient, _ForEach, &FullScreenMode); /* Show all descendants */
