...
// PING sample.
//
#define HOST_TO_PING  IP_BYTES2ADDR(192, 168, 1, 1)  // IP addr. of host that will be periodically PINGed by this sample.
...
static const char *_ICMPContent = "This is an ICMP echo request!";
