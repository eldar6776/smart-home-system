...
*    Outputs a string
*/
static void _Output(char *sString) {
  U8   ac[8];
  char cTemp;
  unsigned int i;
  unsigned int j;
...
#endif
void MainTask(void) {
  char * sInfo0 = "This sample is based on the Segger emUSB software with an HID component. ";
  char * sInfo1 = "For further information please visit: www.segger.com ";
